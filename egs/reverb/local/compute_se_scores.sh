...
pesqdir=$3
enhancement_directory_sim=$enhancement_directory/DNN-WPE/${nch}ch/REVERB_WSJCAM0_dt/data/
enhancement_directory_real=$enhancement_directory/DNN-WPE/${nch}ch/MC_WSJ_AV_Dev/
expdir=${PWD}/data/compute_se_${nch}ch
if $enable_pesq; then
   compute_pesq=1
else
   compute_pesq=0
